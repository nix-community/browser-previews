{
  beta = {
    hash_deb_amd64 = "sha256-HV2JqmpFuLqSEHbZrrG1A5t1PhuOEhIDkYEy9kxEwg0=";
    version = "120.0.6099.4";
  };
  dev = {
    hash_deb_amd64 = "sha256-GrQeNKnnDO6l9XVyCvJ8D0Q8cdWxDVUrnkb7rgpgyEc=";
    version = "120.0.6089.0";
  };
  stable = {
    chromedriver = {
