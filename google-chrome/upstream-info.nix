{
  beta = {
    hash_deb_amd64 = "sha256-KQZPh6chqPZ6QkbAa9GzyrBV/V8aO8OIL5lAqYBgAOE=";
    version = "122.0.6261.18";
  };
  dev = {
    hash_deb_amd64 = "sha256-4xsq2lONhN30r34cFLDaZaMUrJWoearBIjLsjQ3WTRg=";
    version = "123.0.6272.2";
  };
  stable = {
    chromedriver = {
