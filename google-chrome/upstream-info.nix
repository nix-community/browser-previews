{
  beta = {
    hash_deb_amd64 = "sha256-4TkoDgmThRfNlkaDDZ8+3YO6gePzlVWoG76nXH0CjUI=";
    version = "121.0.6167.47";
  };
  dev = {
    hash_deb_amd64 = "sha256-MDSwKZ5UKX30qp/kIZRILBP5am+MilMGGP4FizVbZDY=";
    version = "122.0.6182.0";
  };
  stable = {
    chromedriver = {
