{
  beta = {
    hash_deb_amd64 = "sha256-9Dkab95pbsmDWKybOOIYeQ33MpdwDHk0zzCZFQ8q6M0=";
    version = "122.0.6261.39";
  };
  dev = {
    hash_deb_amd64 = "sha256-KGhnukdhkGD8uFBpJs/MWHBLaO6qLFECoGvMUkqyeLg=";
    version = "123.0.6300.3";
  };
  stable = {
    chromedriver = {
