{
  beta = {
    hash_deb_amd64 = "sha256-x8dWdmVdw2Xl4A26RXNyY/IvNgjVfh8zmfxjIK4giuE=";
    version = "120.0.6099.18";
  };
  dev = {
    hash_deb_amd64 = "sha256-wKzOCZbdo7dluXQhN92wtZFFjqA9x3sa4Mp2D0FUWcE=";
    version = "121.0.6115.2";
  };
  stable = {
    chromedriver = {
